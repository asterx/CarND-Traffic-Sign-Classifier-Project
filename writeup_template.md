...
Firstly I normalized data (in case of Gradient Descent normalization gives the error surface a more spherical shape and as a result it works much better).
Then applied one-hot encoding to convert label numbers to vectors.
@TODO: Split data
